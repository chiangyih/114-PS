...
# ==================== 顯示設定摘要 ====================
Write-Host "`n===============================================================================" -ForegroundColor Cyan
Write-Host "  即將設定兩張網卡的固定 IP 位址（根據表A規格）" -ForegroundColor Cyan
Write-Host "===============================================================================" -ForegroundColor Cyan
Write-Host "  崗位編號：$XX" -ForegroundColor White
Write-Host "`n【LAN 網卡】" -ForegroundColor Yellow
Write-Host "  介面名稱：$Interface_LAN"  # 顯示 LAN 網卡介面名稱
...
Write-Host "  介面名稱：$Interface_WAN"  # 顯示 WAN 網卡介面名稱
...
# ==================== 驗證設定 ====================
Write-Host "`n===============================================================================" -ForegroundColor Cyan
Write-Host "  驗證網卡設定結果" -ForegroundColor Cyan
Write-Host "===============================================================================" -ForegroundColor Cyan

# 驗證 LAN 網卡
Write-Host "`n【LAN 網卡 - $Interface_LAN】" -ForegroundColor Yellow
$IPConfig_LAN = Get-NetIPAddress -InterfaceAlias $Interface_LAN -AddressFamily IPv4  # 取得 LAN 網卡的 IPv4 設定
$DNS_LAN_Config = Get-DnsClientServerAddress -InterfaceAlias $Interface_LAN -AddressFamily IPv4  # 取得 LAN 網卡的 DNS 設定
...
# 驗證 WAN 網卡
Write-Host "`n【WAN 網卡 - $Interface_WAN】" -ForegroundColor Yellow
$IPConfig_WAN = Get-NetIPAddress -InterfaceAlias $Interface_WAN -AddressFamily IPv4  # 取得 WAN 網卡的 IPv4 設定
...
Write-Host "`n===============================================================================" -ForegroundColor Cyan
Write-Host "[完成] 兩張網卡的 IP 位址設定完成！（根據表A規格）" -ForegroundColor Green  # 顯示完成訊息
Write-Host "  LAN: 172.16.$XXNum.254/24" -ForegroundColor White  # 顯示 LAN IP
Write-Host "  WAN: 120.118.$XXNum.1/24" -ForegroundColor White  # 顯示 WAN IP
Write-Host "===============================================================================`n" -ForegroundColor Cyan
